...
golem::fill_desc(
  ...
  author_email = "christian.luechtenborg@gmail.com", # Your Email
  repo_url = "https://github.com/luechtian/ShinyLipidcountr.git" # The URL of the GitHub Repo (optional)
)
...
usethis::use_mit_license( "Christian Luechtenborg" )  # You can set another license here
usethis::use_readme_rmd( open = FALSE )
usethis::use_code_of_conduct("christian.luechtenborg@gmail.com")
